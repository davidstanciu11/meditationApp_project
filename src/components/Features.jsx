...
function Features() {
  ...
  return (
    <>
      <section className="bg-section min-h-[428px] pt-8 pb-[38px] lg:pb-[100px] mt-[120px] lg:mt-[150px]">
        <div className="container mx-auto">
          <div
            className="bg-video h-[310px] bg-cover bg-center bg-no-repeat 
          lg:h-[622px] w-full flex justify-center items-center rounded-md -mt-[150px]  mb-[28px] lg:mb-10"
          >
            <div
              onClick={() => {
                setIsOpen(!isOpen);
