...
function Courses() {
  return (
    <>
      <section className="section-sm lg:section-lg transition" id="Courses">
        <div className="container mx-auto">
          <div className="text-center mb-16 lg:mb-32">
            <h2 className="h2 mb-3 lg:mb-[18px]" data-aos="fade-down" data-aos-delay="200">Popular Courses</h2>
            <p className="max-w-[480px] mx-auto text-sm" data-aos="fade-down" data-aos-delay="200">
